  ...
  return (
    <main className="container mx-auto px-4 pt-8 pb-12 md:pt-10 md:pb-16 max-w-7xl relative">
      ...
      <img
        ...
        className="mao-colar-anim hidden md:block pointer-events-none select-none absolute top-0 right-0 w-[220px] lg:w-[280px] xl:w-[320px] z-20 translate-x-[45%] -translate-y-2"
