...
// Motivo: o Vercel limita o corpo da requisição a ~4.5MB. Uma foto de celular em
// base64 estoura esse limite. Aqui reescalamos para no máx. ~1280px e reenviamos
// como JPEG, mantendo o base64 pequeno (~300-800KB) sem perda visível.
