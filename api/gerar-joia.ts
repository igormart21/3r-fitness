...
Be extremely specific with angles and positions. This is for sculpting — precision matters above everything.`,
    ...
    const prompt = [
      ...
      `• Camera: macro lens, perpendicular front view, FULL pendant centered with generous empty space on ALL sides — at least 15% margin on every edge so the ENTIRE pendant fits within the frame with NO cropping`,
